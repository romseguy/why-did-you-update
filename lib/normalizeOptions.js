...
var normalizeOptions = exports.normalizeOptions = function normalizeOptions() {
  ...
  var _opts$collapseCompone = opts.collapseComponentGroups,
      ...
      _opts$include = opts.include,
      include = _opts$include === undefined ? [DEFAULT_INCLUDE] : _opts$include,
      _opts$includeFunction = opts.includeFunctions,
      includeFunctions = _opts$includeFunction === undefined ? true : _opts$includeFunction,
      _opts$mergeDiffs = opts.mergeDiffs,
      mergeDiffs = _opts$mergeDiffs === undefined ? false : _opts$mergeDiffs,
      _opts$onlyFunctions = opts.onlyFunctions,
      onlyFunctions = _opts$onlyFunctions === undefined ? false : _opts$onlyFunctions,
